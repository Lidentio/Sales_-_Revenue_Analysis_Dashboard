# SalesIQ — Revenue Intelligence Dashboard
...
🔗 **[Live Demo](https://lidentio.github.io/Sales_-_Revenue_Analysis_Dashboard/)**
...
Your dashboard will be live at `https://lidentio.github.io/Sales_-_Revenue_Analysis_Dashboard/` within about a minute.
...
Three test CSVs are included in this repo to try different import scenarios:

| File | Rows | Theme | Tests |
|---|---|---|---|
| `retail_sales.csv` | 480 | Grocery / FMCG | Standard column names |
| `ecommerce_orders.csv` | 200 | Fashion / apparel | Non-standard names (`item`, `type`, `territory`, `quantity`, `amount`) |
| `saas_revenue.csv` | 288 | SaaS subscriptions | Heavily different names (`sku`, `segment`, `zone`, `sold`, `total`) |
...
├── retail_sales.csv     # Sample data — grocery theme
├── ecommerce_orders.csv # Sample data — fashion theme
├── saas_revenue.csv     # Sample data — SaaS theme
└── README.md
```
